...
class Dataset_Custom(Dataset):
    def __init__(self, root_path, flag='train', size=None,
        ...
        self.enc_in = self.data_x.shape[-1]
        self.tot_len = self.length # len(self.data_x) - self.seq_len - self.pred_len + 1
    ...
    def __read_data__(self):
        ...
        # total_length = (len(self.data_x) - self.seq_len - self.pred_len + 1) * self.enc_in
        # indices = torch.randperm(total_length)
        # self.indices = indices[:self.length]
