...
class ResMLP(nn.Module):
    def __init__(self, in_and_out_dim, activation, layer_num, hidden_dim=None):
        ...
        print("Current hidden_dim:", hidden_dim)
...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        self.encoder = ResMLP(configs.d_model,hidden_dim=configs.d_model,layer_num=configs.e_layers,activation='gelu')
        # else:
        #     assert False
    ...
    def forecast(self, x_enc, x_mark_enc, x_dec, x_mark_dec):
        ...
        # dec_out = self.mlp(x_enc).permute(0,2,1)
